...
export function MinimizedStream({ url, index }: MinimizedStreamProps) {
  ...
  return (
    <div
      className="group relative h-full w-32 flex-shrink-0 overflow-hidden rounded-lg bg-neutral-800 transition-all hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/20 cursor-pointer"
